...
namespace UntStudio.Server.Migrations.PluginSubscriptionsDatabase
{
    /// <inheritdoc />
    public partial class InitialMigrationPluginSubscriptionsDatabaseContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseKey = table.Column<string>(type: "nvarchar(19)", maxLength: 19, nullable: false),
